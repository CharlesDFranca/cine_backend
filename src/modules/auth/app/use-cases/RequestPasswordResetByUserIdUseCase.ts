...
type RequestPasswordResetByUserIdInput = {
  userId: string;
};

type RequestPasswordResetByUserIdOutput = {
  message: string;
};

@injectable()
export class RequestPasswordResetByUserIdUseCase
  implements
    IUseCase<
      RequestPasswordResetByUserIdInput,
      RequestPasswordResetByUserIdOutput
    >
{
  constructor(
  ...
  async execute(
    input: RequestPasswordResetByUserIdInput,
  ): Promise<RequestPasswordResetByUserIdOutput> {
